...
// VERIFICANDO USUARIO
function VerificaUsuario(request: Request, response: Response, next: NextFunction) {
...
async function Autoriza(request: Request, response: Response, next: NextFunction) {
