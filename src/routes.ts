...
import { ControleUpdateMensagem } from "./Controller/ControleMensagens/AtualizaMensagem";
...
Rotas.get("/Acessos/:opt_cod_cli", VerificaUsuario, buscaAcesso.handle);
Rotas.get("/ConsultaClientes", VerificaUsuario, consultaClientes.handle);
Rotas.get("/Contatos/:opt_cod_cli", VerificaUsuario, buscaContato.handle);
